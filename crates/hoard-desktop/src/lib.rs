...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::groups::remove_member,
            commands::groups::delete_group,
            commands::groups::share_save,
            commands::groups::unshare_save,
            commands::groups::claim_world,
            commands::groups::release_world,
            commands::groups::force_world,
            commands::groups::dismiss_world,
            commands::groups::get_lease,
